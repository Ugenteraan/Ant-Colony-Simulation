...
const ANT_TURN_PROBABILITY: f32 = 0.03;
const FOOD_SPAWN_RATE: f32 = 0.05;
const ANT_WEAK_PHEROMONE_INTENSITY: f32 = 0.3;
const ANT_STRONG_PHEROMONE_INTENSITY: f32 = 10.0;
const PHEROMONE_DECAY_RATE: f32 = 0.0001;
...
impl MyApp {
    pub fn new(world: World) -> Self {
    	...
    	let system = System::new(ANT_ENERGY, ANT_LIFESPAN, ANT_SPEED, ANT_TURN_PROBABILITY, FOOD_SPAWN_RATE, ANT_STRONG_PHEROMONE_INTENSITY, ANT_WEAK_PHEROMONE_INTENSITY, PHEROMONE_DECAY_RATE); //initialize the system that governs the simulation.
