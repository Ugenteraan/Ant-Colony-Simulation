...
pub fn draw_nest(ui: &mut egui::Ui, world: &World, nest_position_x: usize, nest_position_y: usize, nest_texture: &Option<egui::TextureHandle>, available_size: &egui::Vec2, painter: &egui::Painter) -> () {
