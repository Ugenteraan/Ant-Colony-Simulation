...
pub fn draw_nest(
    ...
    let ui_x = nest_position_x * (available_size.x / world.width as f32) - 10.0;
    let ui_y = nest_position_y * (available_size.y / world.height as f32) - 10.0;
...
pub fn draw_ant(
    ...
    let ui_x = x * (available_size.x / world.width as f32) - 5.0;
    let ui_y = y * (available_size.y / world.height as f32) - 5.0;
